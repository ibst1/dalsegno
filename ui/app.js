...
const STR = {
  ...
  sv: {
    ...
    thWindowTip: 'Vilka fönster raden gäller. En regels text och program redigeras direkt här och sparas när du lämnar fältet. Håll muspekaren över raden för att se fönstret läget sparades från.',
    thIdentityTip: 'Vad läget sparas under - alltså vilka fönster som delar det. "standard" betyder alla fönster i samma program och fönsterklass; "regel" betyder alla fönster regeln matchar.',
    ...
    forgetSel: 'Glöm markerade', saveAll: 'Spara alla nu', saveAllTip: 'Spara alla öppna fönsters nuvarande lägen',
    applyAll: 'Flytta alla nu', applyAllTip: 'Flytta alla öppna fönster till sina sparade lägen ({mod} + Home)',
    addRule: '+ Lägg till regel', addRuleTip: 'En ny regelrad - skriv texten och tryck Enter',
    posEmpty: 'Inga regler och inga sparade lägen för den här skärmuppsättningen ännu. Dra ett fönster dit du vill ha det, spara med {mod} + S, eller håll {mod} och högerklicka på ett fönster.',
    ...
    savedFromTip: 'Sparat från: {0}', noPosYet: 'inget läge ännu',
    patternPh: 'text i titeln', exePh: '(alla)', regexLbl: 'regex',
    noDesktop: '(inget)', followLbl: 'följ efter',
    deleteRule: 'Ta bort regel', deleteRuleTip: 'Ta bort regeln och dess sparade lägen i alla skärmuppsättningar',
    ...
    thProgram: 'Program', thTitle: 'Titel', thWinDesktop: 'Skrivbord', thSaved: 'Sparat läge',
    ...
    savedYes: '✓ finns', saveBtn: 'Spara läge', saveTip: 'Spara fönstrets nuvarande läge',
    ...
    menuH: 'Fönstermeny',
    menuHelp: 'Håll modifieraren och tryck knappen på ett fönster för att öppna menyn. Vanligt högerklick lämnas till appen. Modifieraren är också tangenten lägeskortkommandona nedan hålls med.',
    ...
    behaveH: 'Lägen',
    tglMove: 'Flytta nya fönster automatiskt', tglSave: 'Spara läge vid manuell flytt',
    ...
    tglNotify: 'Notiser',
    managedH: 'Vilka fönster får lägen',
    onlyRules: 'Hantera <b>endast</b> fönster som matchar en regel',
    onlyRulesHelp: 'Av (standard): alla fönster hanteras. Ett fönster som inte matchar någon regel identifieras av sitt program och sin fönsterklass, så alla fönster i samma program delar ett läge. På: bara fönster som matchar en regel får ett läge över huvud taget.',
    onlyRulesExeH: 'Endast regler för dessa program',
    onlyRulesExeHelp: 'Program som bara hanteras via regler (ett exenamn per rad). Deras övriga fönster lämnas i fred. Det naturliga valet för en webbläsare: varje popup är ett eget fönster som annars skulle dela läge med webbläsarens alla andra fönster.',
    ...
    hkOpenUi: 'Öppna DalSegno-fönstret', hkSaveActive: 'Spara det aktiva fönstrets läge',
    hkSaveAll: 'Spara alla öppna fönsters lägen', hkApplyAll: 'Flytta alla fönster till sina sparade lägen',
    hkForgetActive: 'Glöm det aktiva fönstrets läge', hkToggleMove: 'Växla automatisk flyttning', hkReload: 'Starta om skriptet',
    langH: 'Språk', langHelp: 'Gäller det här fönstret, tray-menyn, fönstermenyn och överlägget.',
    filesH: 'Filer', openIni: 'Öppna filen med sparade lägen…', openConfig: 'Öppna konfigfilen…', reload: 'Läs om inställningar',
